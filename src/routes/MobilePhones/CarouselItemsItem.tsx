...
const CarouselItemsItem = ({ id, nameOfItem, image, price }: CarouselItemProps) => {
    ...
    return (
        <div className="d-flex flex-column border-5 border-dark rounded w-90">
            ...
            <div style={{
                ...
                <Link className={css.link} to={`/phones/${id}`}>
                    Read More
                </Link>
...
export default CarouselItemsItem;